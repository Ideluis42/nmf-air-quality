...
Now, you need to load the following packages that this file uses to do the analysis. If this chunk fails to run, you probably don't have a package installed on your machine -- you can install the package using the R console with this line: `install.packages("Package Name")`.
...
data_path <- "SB/cleaned_modpm.RData" # change with your data path
